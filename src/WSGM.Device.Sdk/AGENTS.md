...
- **Static data, not injection.** The SDK defines and validates a glyph profile, control map, and
  assets. Authoring/scaffolding and previews belong to Device Lab; Steam selectors, CDP calls, and
  patch apply/verify belong to WSGM. A plugin must never reach the user's authenticated Steam CEF
  context through this assembly.
